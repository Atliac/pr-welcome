...
1. **Link and Auto-Close Issues:**
   ...
   If this PR fixes any existing issues, please make sure to include closing keywords (such as `close #123` or `fix #456`) in your first PR message (the main description). This links the issues and automatically closes them when this PR is merged.
...
_Automated message maintained by [Atliac](https://github.com/Atliac/pr-welcome)._
